...
let tableData=`
  ...
  <tbody>`;
      ...
      <td>${vehiclehub.website}</td>
       <td><img src="uploads/vehiclehub/${vehiclehub.image1}" alt=""  width="150px" height="150px"></td>
    <td><img src="uploads/vehiclehub/${vehiclehub.image2}" alt=""  width="150px" height="150px"></td>
    <td><img src="uploads/vehiclehub/${vehiclehub.image3}" alt=""  width="150px" height="150px"></td>
    <td><img src="uploads/vehiclehub/${vehiclehub.image4}" alt=""  width="150px" height="150px"></td>
    <td><img src="uploads/vehiclehub/${vehiclehub.image5}" alt=""  width="150px" height="150px"></td>
