...
<form>
  ...
  <div class="mb-3">
    <label for="exampleInputVehicles" class="form-label">Vehicles</label>
    <input type="text" class="form-control" id="exampleInputVehicles" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
