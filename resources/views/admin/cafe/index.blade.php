...
let tableData=`
  ...
  <tbody>`;
      ...
      <td>${cafe.email}</td>
      <td>${cafe.website}</td>
   <td><img src="uploads/cafe/${cafe.image1}" alt="" width="150px" height="150px"></td>
    <td><img src="uploads/cafe/${cafe.image2}" alt="" width="150px" height="150px"></td>
    <td><img src="uploads/cafe/${cafe.image3}" alt="" width="150px" height="150px"></td>
    <td><img src="uploads/cafe/${cafe.image4}" alt="" width="150px" height="150px"></td>
    <td><img src="uploads/cafe/${cafe.image5}" alt="" width="150px" height="150px"></td>
