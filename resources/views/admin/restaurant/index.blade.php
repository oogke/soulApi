...
<div class="header">
    ...
    <a href="{{ Route('createRestaurants')}}"><button class="btn btn-link btn-primary" id="create-btn">Create post</button></a>
...
let tableData=`
  ...
  <tbody>`;
            ...
            let n = 1;
            for( var restaurant of data.data)
            {
                tableData+=`  <tr>
      <th scope="row">${n++}</th>
      ...
      <td>${restaurant.image1}</td>
      <td>${restaurant.image2}</td>
      <td>${restaurant.image3}</td>
      <td>${restaurant.image4}</td>
      <td>${restaurant.image5}</td>
