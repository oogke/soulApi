...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('places', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('places', 'district_id')) {
            ...
            // Add the foreign key constraint to reference the 'district' column in 'districts' table
            $table->foreign('district')
                ->references('name') // Reference the 'district' column of the 'districts' table
