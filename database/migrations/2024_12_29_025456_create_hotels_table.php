...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('hotels', function (Blueprint $table) {
            ...
            $table->text('description'); // Hotel description
            $table->string('location'); // Hotel location
            $table->string('phone'); // Hotel phone number
            $table->string('email')->unique(); // Hotel email address
            $table->string('website')->nullable(); // Hotel website (nullable)
            $table->string('district'); // Hotel district
