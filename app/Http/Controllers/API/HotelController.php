...
$query->where('rating','LIKE',"%{$rating}%");
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($validate->fails())
        {
            ...
            //image
$cafeImage= Hotel::select('id','image1','image2','image3','image4','image5')->where('id',$id)->first();
$images=[];
...
//image
$hotelUpdate=Hotel::where('id',$id)->update([
...
if($hotelUpdate >0)
{
    return $this->sendResponse($hotel,"Data is updated successfully");
}
else{
    ...
    public function destroy(string $id)
    {
        ...
        {
            $filepath=public_path('uploads/hotel/').$hotel->$img;
